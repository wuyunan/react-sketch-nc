...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37)["setTimeout"], __webpack_require__(37)["clearTimeout"]))
...
var _normalizeCssColor = __webpack_require__(124);
...
var _layerGroup = __webpack_require__(125);
...
var _expandStyle = __webpack_require__(132);
...
var ReactBaseClasses = __webpack_require__(38);
...
var createReactClass = __webpack_require__(82);
...
var _sketchappJsonPlugin = __webpack_require__(16);

var _findFont = __webpack_require__(54);
...
var checkReactTypeSpec = __webpack_require__(75);
...
var _reactTestRenderer = __webpack_require__(88);
...
var _Context = __webpack_require__(118);

var _Context2 = _interopRequireDefault(_Context);

var _createStringMeasurer = __webpack_require__(119);

var _createStringMeasurer2 = _interopRequireDefault(_createStringMeasurer);

var _hasAnyDefined = __webpack_require__(35);

var _hasAnyDefined2 = _interopRequireDefault(_hasAnyDefined);

var _pick = __webpack_require__(56);
...
var ReactHostComponent = __webpack_require__(51);

var getNextDebugID = __webpack_require__(107);
var invariant = __webpack_require__(1);
var warning = __webpack_require__(2);
...
var _hashStyle = __webpack_require__(55);
...
var _murmur2js = __webpack_require__(120);

var _murmur2js2 = _interopRequireDefault(_murmur2js);

var _sortObjectKeys = __webpack_require__(121);
...
var _renderers = __webpack_require__(122);
...
var _shapeLayers = __webpack_require__(36);
...
var _same = __webpack_require__(59);
...
var _sharedTextStyles = __webpack_require__(130);
...
var _buildTree = __webpack_require__(44);

var _buildTree2 = _interopRequireDefault(_buildTree);

var _flexToSketchJSON = __webpack_require__(57);
...
var _TextStylePropTypes = __webpack_require__(136);
...
/* WEBPACK VAR INJECTION */(function(fetch, console) {Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var _reactSketchapp = __webpack_require__(86);
...
var API_ENDPOINT_URL = 'http://10.12.30.28:8000/Features.json';
...
var VerticalLine = function VerticalLine(_ref) {
    var _ref$height = _ref.height,
        height = _ref$height === undefined ? 1 : _ref$height,
        _ref$color = _ref.color,
        color = _ref$color === undefined ? '#46D2B3' : _ref$color;
...
var Footer = function Footer() {
    return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
            _reactSketchapp.View,
            { style: styles.rowLeftArea },
            _react2['default'].createElement(VerticalLine, { height: 40 })
        )
    );
};
...
var Dot = function Dot(_ref3) {
    ...
    return _react2['default'].createElement(_reactSketchapp.View, { name: 'Dot', style: [styles.dot, completed && styles.dotCompleted] });
};
...
var Row = function Row(_ref4) {
    ...
    return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
            _reactSketchapp.View,
            { name: 'Row Left', style: styles.rowLeftArea },
            _react2['default'].createElement(VerticalLine, null),
            _react2['default'].createElement(Dot, { completed: completed }),
            _react2['default'].createElement(VerticalLine, { height: 4 })
        ),
        _react2['default'].createElement(
            _reactSketchapp.View,
            { name: 'Row Body', style: { opacity: completed ? 1 : 0.5 } },
            _react2['default'].createElement(
                _reactSketchapp.Text,
                {
                    name: 'Row Date',
            ...
            _react2['default'].createElement(
                _reactSketchapp.Text,
                { name: 'Row Description', style: styles.rowDescription },
                description
            )
        )
    );
...
var Timeline = function Timeline(props) {
    return _react2['default'].createElement(
        ...
        _react2['default'].createElement(Header, { title: 'Product Timeline' }),
        props.data.records.map(function (_ref5) {
            var id = _ref5.id,
                fields = _ref5.fields;
...
exports['default'] = function (context) {
    fetch(API_ENDPOINT_URL).then(function (res) {
        return res.json();
    }).then(function (data) {
        (0, _reactSketchapp.render)(_react2['default'].createElement(Timeline, { data: data }), context.document.currentPage());
    })['catch'](function (e) {
        return console.error(e);
    }); // eslint-disable-line no-console
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(67), __webpack_require__(11)))
...
var _Artboard = __webpack_require__(138);
...
var _RedBox = __webpack_require__(63);
...
var _TextStyles = __webpack_require__(61);
...
var ReactHostComponent = __webpack_require__(51);
var ReactTestMount = __webpack_require__(111);
var ReactTestReconcileTransaction = __webpack_require__(113);
var ReactUpdates = __webpack_require__(23);
var ReactTestTextComponent = __webpack_require__(115);
var ReactTestEmptyComponent = __webpack_require__(116);
var invariant = __webpack_require__(1);
...
var renderers = {
  artboard: __webpack_require__(123),
  image: __webpack_require__(126),
  text: __webpack_require__(128),
  view: __webpack_require__(60),
  symbolinstance: __webpack_require__(131),
  symbolmaster: __webpack_require__(133)
};
...
var _ViewRenderer = __webpack_require__(60);

var _ViewRenderer2 = _interopRequireDefault(_ViewRenderer);

var _textLayers = __webpack_require__(129);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(root, factory) {
    ...
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(135)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports === 'object') {
